    ...
    return(
        <div>
            ...
            <div className="max-w-2xl mx-auto py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
                ...
                <div class="max-w-sm -space-x-2 bg-white rounded-lg border shadow-lg dark:bg-white-800">
                    <div class="flex flex-col items-center pb-10">
                        <img class="mb-3 w-24 h-24 rounded-full shadow-lg" src="/docs/images/people/profile-picture-3.jpg" alt="Bonnie image" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{host?.name}</h5>
                        <span class="text-sm text-gray-500 dark:text-gray-400">House Agent</span>
