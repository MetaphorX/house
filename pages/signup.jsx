    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2 sm:mt-5">
        <div className='bg-gray-100 rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
            <div className='w-full md:w-3/5 p-5'>
                ...
                <div className='py-6'>
                    <h2 className='text-3xl font-bold text-red-500 mb-2 text-center border-b-2 border-red-500 pb-4'>Sign in</h2>
                </div>
                ...
                <p className='text-gray-500 text-sm my-3 text-center'>Login in with Username and Password</p>
                <div className='flex flex-col items-center'>
                    <div className='bg-white w-64 p-2 flex items-center'>
                        <FaUser className="text-gray-300 m-2"/>
                        <input type="text" name="username" placeholder='Username' className='outline-none flex-1'/>
                    </div>

                    <div className='bg-white w-64 p-2 flex items-center mt-3'>
                        <MdLockOutline className="text-gray-300 m-2"/>
                        <input type="password" name="password" placeholder='Password' className='outline-none flex-1'/>
                    </div>
                    ...
                    <a href="#" className='border-2 border-white bg-red-500 text-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-red-500 hover:border-red-500'>Sign In</a>

                </div>
            </div>
            <div className='sign w-2/5 bg-red-500 text-white text-center rounded-tr-2xl rounded-br-2xl py-36 px-12'>
                <h2 className="text-2xl font-bold mb-2 border-b-2 pb-4">New Agent!!</h2>
                <p className='mb-10'>Be a <span className='font-bold text-xs'>Rent-Crib</span> agent</p>
